...
export MODEL_CONSTRAINTS="arch=ppc64el tags=uosci"
export BOOTSTRAP_CONSTRAINTS="arch=ppc64el tags=uosci"
export BOOTSTRAP_PLACEMENT="--to node-huffman"  # Huffman has multipath storage
